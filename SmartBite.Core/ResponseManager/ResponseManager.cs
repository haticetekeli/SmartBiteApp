namespace SmartBite.Core.ResponseManager
{
    public static class ResponseManager
    {
        ...
        public static BaseResponseModel Ok(string message = "Success")
        {
            return new BaseResponseModel
            {
                Success = true,
        ...
        // Generic versiyonlar
        public static BaseResponseModel<T> Ok<T>(T data, string message = "Success")
        {
